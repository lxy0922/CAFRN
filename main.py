...
parser.add_argument('--hr_train_dataset', type=str, default='AID')
...
parser.add_argument("--resume", default="weights/.pth", type=str, help="Path to checkpoint (default: none)")
...
def save_checkpoint(model, epoch):
    ...
    model_out_path = model_folder + opt.model_type +"_epoch_{}.pth".format(epoch)
